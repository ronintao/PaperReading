...
为了**算出解析式解**看清奇异行为，把曲柄滑块换一种建模（图 3.7.6）：用**绝对约束**把物体 1、2 与地面耦合，使 $x_1=y_1=y_2=\phi_2=0$，于是**只剩 $x_2\equiv q$ 一个广义坐标**。曲柄以恒定角速度 $\omega$ 驱动，$\phi_1=\omega t$。
...
即：（书中以 $\mp$ 排版（先 $-$）以使加号对应图 3.7.6 的装配构型、减号对应图 3.7.7 的另一装配：）
